...
<body>
    <div class="container">
        <div class="img_txt">
            <img src="../../../public/assets/demonios.jpg" class="imagem" alt="Imagem do livro">
            <div class="data">Publicado em 1872</div>
        </div>
        <div class="conteudo">
            <div class="titulo">Os Demônios</div>
            <div class="autor">Fiodor Dostoiévski</div>
            <div class="estrela_sinopse">
                ...
                <div class="sinopse">
                    <p class="resumo">Impressionado com o assassinato de um estudante por um grupo niilista, Dostoiévski
                        concebeu
                        este livro como um protesto contra os que queriam transplantar a realidade política e cultural
                        da
                        Europa ocidental para a Rússia. Apesar da intenção inicialmente panfletária, Os demônios é um
                        romance
                        magistral, à altura de Crime e castigo ou Os irmãos Karamázov.</p>
                </div>
