                ...
                <div class="forma-post1" onclick="location.href='publicacoes/post?id=<?= $post->id ?>';">
                    <div class="espassocapa">
                        ...
                        <div class="titulo-do-post">
                            <h3><?php
                                if (mb_strlen($post->titulo_post) > 40) {
                                    $post->titulo_post = mb_substr($post->titulo_post, 0, 40) . '...';
                    ...
                    <div class="capalivro1">
                        <img style="border-radius: 10px;" src="<?php if ($post->imagem != null) {
                                                                    echo $post->imagem;
                                                                } ?>" width="140px">
                    </div>
                </div>
                ...
                <div id="alternador" class="paginacao">
                    ...
                    <nav class="navpaginacao">
                        <ul class="paginacao-numeros">
                            ...
                            <?php if ($page - 3 >= 1) : ?>
                                <li onclick="location.href = '?pagina=<?= $page - 3 ?>';" class="paginacao-item"><a class="paginacao-link" href="?pagina=<?= $page - 3 ?>"><?= $page - 3 ?></a></li>
                            <?php endif; ?>

                            <?php if ($page - 2 >= 1) : ?>
                                <li onclick="location.href = '?pagina=<?= $page - 2 ?>';" class="paginacao-item"><a class="paginacao-link" href="?pagina=<?= $page - 2 ?>"><?= $page - 2 ?></a></li>
                            <?php endif; ?>

                            <?php if ($page - 1 >= 1) : ?>
                                <li onclick="location.href = '?pagina=<?= $page - 1 ?>';" class="paginacao-item"><a class="paginacao-link" href="?pagina=<?= $page - 1 ?>"><?= $page - 1 ?></a></li>
                            <?php endif; ?>

                            <li class="paginacao-item"><a style="color: #f5f5f5; text-decoration: none;" class="paginacao-link active"><?= $page ?></a></li>
