...
<body>
    <main>
        <div class="cabecalho">
            <button type="button" class="botoes-fora-tabela" id="botao-criar-post" onclick="abrirModal('adiciona-post')"><i class="bi bi-plus-lg"></i> Criar post</button>
                ...
                <tbody>
                    <?php foreach ($posts as $post) : ?>
                        <tr class="linha-normal">
                            ...
                            <td class="espaco-visualizar"><button type="button" class="botao-visualizar" onclick="abrirModal('visualizar<?php echo $post->id ?>')"><i class="bi bi-eye-fill"></i><br>Visualizar</button>
                            </td>
                            <td class="espaco-editar"><button type="button" class="botao-editar" onclick="abrirModal('edit-post<?php $post->id ?>')"><i class="bi bi-pencil-square"></i><br>Editar</button>
                            </td>
                            <td class="espaco-excluir"><button type="button" class="botao-excluir" onclick="abrirModal('rm-post<?php echo $post->id ?>')"><i class="bi bi-trash3-fill"></i><br>Deletar</button>
                            </td>
                        </tr>
                        ...
                        <tr class="botoes-mobile">
                            <td class="linha-botoes" colspan="2">
                                <div class="container-botoes">
                                    <button type="button" class="botao-visualizar" onclick="abrirModal('visualizar<?php echo $post->id ?>')"><i class="bi bi-eye-fill"></i><br>Visualizar</button>
                                    <button type="button" class="botao-editar" onclick="abrirModal('edit-post<?php $post->id ?>')"><i class="bi bi-pencil-square"></i><br>Editar</button>
                                    <button type="button" class="botao-excluir" onclick="abrirModal('rm-post<?php echo $post->id ?>')"><i class="bi bi-trash3-fill"></i><br>Deletar</button>
                                </div>
                            </td>
                        </tr>
                        ...
                        <div class="cont-modal" id="visualizar<?php echo $post->id ?>">
                            ...
                            <div class="content">
                                        ...
                                        <div class="esquerda">
                                            <h3>Autor</h1>
                                                ...
                                                <h3>Título</h1>
                                                    ...
                                                    <h3>Review</h1>
                                                        <textarea rows="14" cols="50" readonly><?php echo $post->review ?></textarea>
                                        </div>
                                        <div class="direita">
                                ...
                                <button class="fecha" onclick="fecharModal('visualizar<?php echo $post->id ?>')">&times;</button>
                            </div>
                        </div>
                        ...
                        <div id="rm-post<?php echo $post->id ?>" class="cont-modal">
                            <div class="content">
                                <a class="fecha" onclick="fecharModal('rm-post<?php echo $post->id ?>')" href="#">&times;</a>
                                ...
                                <form action="post/deletar" method="POST">
                                    ...
                                    <div class="rm-ct">
                                        ...
                                        <div class="botoes-rm">
                                            ...
                                            <button class="cancelar" onclick="fecharModal('rm-post<?php echo $post->id ?>')" type="button">Cancelar</button>
                                ...
                                <form action="post/editar" method="post" enctype="multipart/form-data">
                                    <div class="livro">
                                        <div class="direita">
                                            ...
                                            <input type="text" id="titulo-livro" name="titulo-livro" placeholder="Título do livro" value="Livro">
                                            <label for="autor-livro">Nome do autor</label>
                                            <input type="text" id="autor-livro" name="autor-livro" placeholder="Nome do autor do livro" value="autor">
                                            <label for="ano-pub">Ano de publicação</label>
                                            <input name="ano-pub" id="ano-pub" type="number" placeholder="Ano de publicação" max="2024" value="1990">
                                        </div>
                                        <div class="esquerda">
                                    ...
                                    <div class="formulario">
                                        ...
                                        <div class="esquerda">
                                            ...
                                            <textarea type="text" id="conteudo" name="conteudo" placeholder="Conteudo da sua review" rows="7" cols="50">Sua review</textarea>
                                        </div>

                                        <div class="direita">
                                            <div class="img-prev"><img id="preview2" src="../../../public/assets/capa.jpg" alt="Pré-visualização da imagem">
                                            </div>
                    ...
                    <form action="post/criar" method="post" enctype="multipart/form-data">
                        ...
                        <div class="formulario">
                            <div class="esquerda">
                                ...
                                <br>
                                <label for="conteudo">Review</label><br>
                                <textarea type="text" id="conteudo" name="conteudo" placeholder="Conteudo da sua review" rows="7" cols="50"></textarea>
                            </div>
                            <div class="direita">
                                <div class="img-prev"><img id="preview" src="" alt="Pré-visualização da imagem" style="display: none;">
                                </div>
                                <label for="img">Selecione uma imagem:</label>
